...
export const ClienteAvatarLarge = styled.img`
  width: 100%;
  height: 280px;
  object-fit: cover;
  border-radius: 12px;
...
export const ClienteNameText = styled.h2`
  font-size: 2rem;
  font-family: var(--font-cabourg-bold), 'Cabourg', serif;
  color: #1a1a1a;
  margin: 0;
...
export const ClienteEmailText = styled.p`
  font-size: 1.1rem;
  font-family: var(--font-inter-variable-regular), 'Inter', sans-serif;
  color: #666;
  margin: 0;
...
export const StatusBox = styled.div<{ $status: 'ativo' | 'inativo' }>`
  background-color: ${props => props.$status === 'ativo' ? '#d1e7dd' : '#f8d7da'};
  padding: 16px;
  border-radius: 10px;
  text-align: center;
