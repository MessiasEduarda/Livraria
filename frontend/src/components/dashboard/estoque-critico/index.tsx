...
interface EstoqueCriticoComponentProps {
  id?: string;
}

const produtosCriticos: ProdutoEstoque[] = [
  { 
    id: 1, 
    nome: "Clean Code", 
...
export default function EstoqueCriticoComponent({ id }: EstoqueCriticoComponentProps) {
  ...
  const handleReabastecer = (produtoId: number) => {
    console.log(`Reabastecer produto ${produtoId}`);
  };
    ...
    <Navbar>
      <PageContainer>
        ...
        <Modal>
          ...
          <ModalContent>
            <ModalHeader>
              <ModalTitle>Estoque Crítico</ModalTitle>
            ...
            <ModalBody>
              <StockWarning>
                ...
                <div>
                  <strong>{produtosCriticos.length} produtos</strong> estão com estoque abaixo do mínimo recomendado
                </div>
              </StockWarning>
                ...
                {produtosCriticos.map((produto) => (
                  <ProductItem key={produto.id}>
                    <ProductInfo>
                      ...
                      <ProductCategory>
                        {produto.autor && `${produto.autor} • `}{produto.categoria}
                      </ProductCategory>
                    </ProductInfo>
                    <StockInfo>
                      <StockLevel $critical={true}>
                        <div className="current">{produto.estoqueAtual} un.</div>
                        <div className="minimum">Mín: {produto.estoqueMinimo}</div>
                      </StockLevel>
                      <ActionButton onClick={() => handleReabastecer(produto.id)}>
